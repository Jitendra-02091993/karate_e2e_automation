...
Scenario:Create an entry using POST method and then Update any data in a JSON by using PUT method
  ...
  * def ints = randomInteger()
  ...
  When request {"jobId":201,"jobTitle":"Chemical Engineering","jobDescription":"To test chemical content","experience":["Google","Apple","Mobile Iron","Appium"],"project":[{"projectName":"E-Commerce App","technology":["Kotlin","SQL Lite","Gradle","C++"]}]}
